  ...
  html AboutView =
    [hsx|
        <div class="container">
          ...
          Moreover, Fidelio is an opensource project and its code can reviewed by everybody at <a href="https://github.com/parry84/fidelio">https://github.com/parry84/fidelio</a>. Pretty secure.</p>
        </div>
    |]
